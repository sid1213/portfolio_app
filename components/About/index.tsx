  ...
  return (
    <section>
      <div className="  about  gap-y-10 sm:gap-20 h-fit flex w-full flex-col sm:flex-row justify-between  items-start sm:items-center p-10 sm:p-0">
        <div className=" w-1/2 sm:w-1/3 h-fit sm:m-0  ">
          <Image
        ...
        <div className="sm:w-2/3 sm:min-h-[550px] flex justify-center items-center flex-col sm:p-5 sm:order-1 sm:bg-[#FFEBD9] ">
